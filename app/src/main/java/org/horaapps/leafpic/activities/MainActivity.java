...
import org.horaapps.leafpic.opendocscanner.CropImage;
import org.horaapps.leafpic.opendocscanner.InternalStorageContentProvider;
...
public class MainActivity extends SharedMediaActivity
        implements RvMediaFragment.MediaClickListener, AlbumsFragment.AlbumClickListener,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!albumsMode) {
            rvMediaFragment = (RvMediaFragment) getSupportFragmentManager().findFragmentByTag(
                    RvMediaFragment.TAG);
        ...
        albumsFragment =
                (AlbumsFragment) getSupportFragmentManager().findFragmentByTag(AlbumsFragment.TAG);
        albumsFragment.setListener(this);
        albumsFragment.setEditModeListener(this);
        albumsFragment.setNothingToShowListener(this);
    }
    ...
    private void takePicture() {
        ...
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(state)) {
                mImageCaptureUri =
                        LegacyCompatFileProvider.getUri(getApplicationContext(), mFileTemp);
            } else {
                /*
    ...
    @Override
    public void changedEditMode(boolean editMode, int selected, int total,
            @javax.annotation.Nullable View.OnClickListener listener,
    ...
    private void setupNavigationDrawer() {
        ActionBarDrawerToggle drawerToggle =
                new ActionBarDrawerToggle(this, navigationDrawer, toolbar, R.string.drawer_open,
    ...
    private void setupFAB() {
        fab.setImageDrawable(new IconicsDrawable(this).icon(GoogleMaterial.Icon.gmd_camera_alt)
                .color(Color.WHITE));
        fab.setOnClickListener(
                v -> startActivity(new Intent(MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA)));
    }
    ...
    protected void onPostResume() {
        ...
        new Thread(() -> {
            if (Prefs.getLastVersionCode() < BuildConfig.VERSION_CODE) {
                String titleHtml =
                        String.format(Locale.ENGLISH, "<font color='%d'>%s <b>%s</b></font>",
                                getTextColor(), getString(R.string.changelog),
                                BuildConfig.VERSION_NAME), buttonHtml =
                        String.format(Locale.ENGLISH, "<font color='%d'>%s</font>",
                                getAccentColor(), getString(R.string.view).toUpperCase());
                Snackbar snackbar =
                        Snackbar.make(mainLayout, StringUtils.html(titleHtml), Snackbar.LENGTH_LONG)
                                .setAction(StringUtils.html(buttonHtml),
                                        view -> AlertDialogsHelper.showChangelogDialog(
                                                MainActivity.this));
                View snackbarView = snackbar.getView();
                snackbarView.setBackgroundColor(getBackgroundColor());
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    snackbarView.setElevation(
                            getResources().getDimension(R.dimen.snackbar_elevation));
                }
                snackbar.show();
    ...
    public void updateUiElements() {
        ...
        fab.setVisibility(Hawk.get(getString(R.string.preference_show_fab), false) ? View.VISIBLE
                : View.GONE);
        ...
        navigationDrawerView.setTheme(getPrimaryColor(), getBackgroundColor(), getTextColor(),
                getIconColor());
    ...
    private void resetToolbar() {
        updateToolbar(getString(R.string.app_name), GoogleMaterial.Icon.gmd_menu,
    ...
    public void checkNothing(boolean status) {
        ...
        ((TextView) findViewById(R.id.nothing_to_show_text_emoji_easter_egg)).setTextColor(
                getSubTextColor());
    ...
    public void onBackPressed() {
        ...
        if (albumsMode) {
            ...
            if (!((BaseFragment) getSupportFragmentManager().findFragmentByTag(RvMediaFragment.TAG))
                    .onBackPressed()) {
                goBackToAlbums();
            }
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_CROP_IMAGE:
                ...
                Mat grayImage =
                        Imgcodecs.imread(mFileTemp.getPath(), Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MainActivity.this,
                                "Choose Language and Hit OCR, wait for few seconds for output",
